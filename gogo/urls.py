...
urlpatterns += patterns('cuestionarios_360.views',
	...
	# url(r'^360/instrumento/clonar/(?P<id_instrumento>[0-9]{1,10})/$', 'instrumentoclonar'),
	url(r'^360/instrumento/(?P<id_instrumento>[0-9]{1,10})/dimensiones/$', 'dimensiones'),
	# url(r'^360/instrumento/(?P<id_instrumento>[0-9]{1,10})/dimension/(?P<id_dimension>[0-9]{1,10})/variable/nueva/$', 'variablenueva'),
	# url(r'^360/instrumento/(?P<id_instrumento>[0-9]{1,10})/dimension/(?P<id_dimension>[0-9]{1,10})/variables/$', 'variables'),
	# url(r'^360/instrumento/(?P<id_instrumento>[0-9]{1,10})/dimension/activar/(?P<id_dimension>[0-9]{1,10})/$', 'dimensionactivar'),
	# url(r'^360/instrumento/(?P<id_instrumento>[0-9]{1,10})/dimension/editar/(?P<id_dimension>[0-9]{1,10})/$', 'dimensioneditar'),
	# url(r'^360/instrumento/(?P<id_instrumento>[0-9]{1,10})/dimension/eliminar/(?P<id_dimension>[0-9]{1,10})/$', 'dimensioneliminar'),
	# url(r'^360/instrumento/(?P<id_instrumento>[0-9]{1,10})/dimension/nueva/$', 'dimensionueva'),
	# url(r'^360/pregunta/(?P<id_pregunta>[0-9]{1,10})/$', 'preguntaeditar'),
	# url(r'^360/pregunta/activar/(?P<id_pregunta>[0-9]{1,10})/$', 'preguntactivar'),
	# url(r'^360/pregunta/clonar/(?P<id_pregunta>[0-9]{1,10})/$', 'preguntaclonar'),
	# url(r'^360/pregunta/eliminar/(?P<id_pregunta>[0-9]{1,10})/$', 'preguntaeliminar'),
	# url(r'^360/proyecto/clonar/(?P<id_proyecto>[0-9]{1,10})/$', 'proyectoclonar'),
	# url(r'^360/variable/(?P<id_variable>[0-9]{1,10})/pregunta/nueva/$', 'preguntanueva'),
	# url(r'^360/variable/(?P<id_variable>[0-9]{1,10})/preguntas/$', 'preguntas'),
	# url(r'^360/variable/activar/(?P<id_variable>[0-9]{1,10})/$', 'variableactivar'),
	# url(r'^360/variable/clonar/(?P<id_variable>[0-9]{1,10})/$', 'variableclonar'),
	# url(r'^360/variable/editar/(?P<id_variable>[0-9]{1,10})/$', 'variableditar'),
	# url(r'^360/variable/eliminar/(?P<id_variable>[0-9]{1,10})/$', 'variableliminar'),
)
