...
urlpatterns += patterns('cuestionarios_360.views',
	...
	# url(r'^360/instrumento/editar/(?P<id_instrumento>[0-9]{1,10})/$', 'instrumentonuevo'),
	...
	url(r'^360/dimensiones/$', 'dimensiones'),
	# url(r'^360/dimension/(?P<id_dimension>[0-9]{1,10})/variable/nueva/$', 'variablenueva'),
	# url(r'^360/dimension/(?P<id_dimension>[0-9]{1,10})/variables/$', 'variables'),
	...
	# url(r'^360/dimension/nueva/$', 'dimensionueva'),
