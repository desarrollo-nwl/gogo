// x86_64-linux-gnu-gcc -pthread -fno-strict-aliasing -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -fPIC -I/usr/include/python2.7 -I/usr/include/postgresql -lpqxx -lpq -march=corei7-avx -c focal.cpp -o focal.o && c++ -pthread -shared -Wl,-O1 -Wl,-Bsymbolic-functions -Wl,-Bsymbolic-functions -Wl,-z,relro -fno-strict-aliasing -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -D_FORTIFY_SOURCE=2 -g -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security -march=corei7-avx -lpqxx -lpq -o focal.so -O3
#include <Python.h>
#include <iostream>
#include <pqxx/pqxx>
...
static PyMethodDef focal_metodos[]={
	{"query",(PyCFunction)query,METH_VARARGS},
	{NULL,NULL,0,NULL}
};

PyMODINIT_FUNC initfocal(void){
	Py_InitModule("focal",focal_metodos);
}
