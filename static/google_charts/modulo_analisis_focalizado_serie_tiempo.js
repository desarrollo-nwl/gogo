function drawChart() {
    ...
    data.addColumn('number', 'Estilo de Liderazgo');
    data.addColumn('number', 'Accesibilidad');
    data.addColumn('number', 'Empoderamiento');
    data.addColumn('number', 'Imparcialidad');
	...
	for (var i = 0,
		...
		data.addRow([new Date(2016, 0, i + 1), val1, val2, val3, val4]);
	}
