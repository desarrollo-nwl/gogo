function drawChart() {
    ...
    data.addColumn('number', 'Employer Branding');
    data.addColumn('number', 'Business Strategy');
    data.addColumn('number', 'Leadership');
    data.addColumn('number', 'Team Power');
    ...
    var chart = new google.visualization.ChartWrapper({
        ...
        options: {
            ...
            colors: ['#e2431e', '#f1ca3a', '#6f9654', '#1c91c0','purple','orange'],
            chartArea: {
