...
this.buildSelectAll();this.buildDropdownOptions();this.buildFilter();this.updateButtonText();this.updateSelectAll(!0);this.options.disableIfEmpty&&0>=b("option",this.$select).length?this.disable():this.enable();this.options.dropRight&&this.$ul.addClass("pull-right")},dataprovider:function(a){var c=0,d=this.$select.empty();b.each(a,function(a,f){var g;b.isArray(f.children)?(c++,g=b("<optgroup/>").attr({label:f.label||"Group "+c,disabled:!!f.disabled}),q(f.children,function(a){g.append(b("<option/>").attr({value:a.value,
label:a.label||a.value,title:a.title,selected:!!a.selected,disabled:!!a.disabled}))})):(g=b("<option/>").attr({value:f.value,label:f.label||f.value,title:f.title,"class":f["class"],selected:!!f.selected,disabled:!!f.disabled}),g.text(f.label||f.value));d.append(g)});this.rebuild()},enable:function(){this.$select.prop("disabled",!1);this.$button.prop("disabled",!1).removeClass("disabled")},disable:function(){this.$select.prop("disabled",!0);this.$button.prop("disabled",!0).addClass("disabled")},setOptions:function(a){this.options=
this.mergeOptions(a)},mergeOptions:function(a){return b.extend(!0,{},this.defaults,this.options,a)},hasSelectAll:function(){return 0<b("li.multiselect-all",this.$ul).length},updateSelectAll:function(a){if(this.hasSelectAll()){var c=b("li:not(.multiselect-item):not(.filter-hidden) input:enabled",this.$ul),d=c.length,c=c.filter(":checked").length,e=b("li.multiselect-all",this.$ul),f=e.find("input");if(0<c&&c===d)f.prop("checked",!0),e.addClass(this.options.selectedClass),this.options.onSelectAll(!0);
else if(f.prop("checked",!1),e.removeClass(this.options.selectedClass),0===c&&!a)this.options.onSelectAll(!1)}},updateButtonText:function(){var a=this.getSelected();this.options.enableHTML?b(".multiselect .multiselect-selected-text",this.$container).html(this.options.buttonText(a,this.$select)):b(".multiselect .multiselect-selected-text",this.$container).text(this.options.buttonText(a,this.$select));b(".multiselect",this.$container).attr("title",this.options.buttonTitle(a,this.$select))},getSelected:function(){return b("option",
this.$select).filter(":selected")},getOptionByValue:function(a){var c=b("option",this.$select);a=a.toString();for(var d=0;d<c.length;d+=1){var e=c[d];if(e.value===a)return b(e)}},getInputByValue:function(a){var c=b("li input",this.$ul);a=a.toString();for(var d=0;d<c.length;d+=1){var e=c[d];if(e.value===a)return b(e)}},updateOriginalOptions:function(){this.originalOptions=this.$select.clone()[0].options},asyncFunction:function(a,b,d){var e=Array.prototype.slice.call(arguments,3);return setTimeout(function(){a.apply(d||
window,e)},b)},setAllSelectedText:function(a){this.options.allSelectedText=a;this.updateButtonText()}};b.fn.multiselect=function(a,c,d){return this.each(function(){var e=b(this).data("multiselect"),f="object"===typeof a&&a;e||(e=new k(this,f),b(this).data("multiselect",e));"string"===typeof a&&(e[a](c,d),"destroy"===a&&b(this).data("multiselect",!1))})};b.fn.multiselect.Constructor=k;b(function(){b("select[data-role=multiselect]").multiselect()})}(window.jQuery);
